################################################################################
#
# sigmastar-sdk-sensors
#
# The sensor drivers, built from source against the configured kernel --
# unlike sigmastar-sdk-infinity6e, which is prebuilt vendor binaries. That
...
SIGMASTAR_SDK_SENSORS_VERSION = 8143e4da181d39d569572519595ce4b7e1a9a02d
SIGMASTAR_SDK_SENSORS_SITE = $(call github,openipc,sensors,$(SIGMASTAR_SDK_SENSORS_VERSION))
SIGMASTAR_SDK_SENSORS_LICENSE = GPL-2.0
...
SIGMASTAR_SDK_SENSORS_MODULE_SUBDIRS = $(SOC_VENDOR)/$(SOC_FAMILY)
SIGMASTAR_SDK_SENSORS_MODULE_MAKE_OPTS = \
